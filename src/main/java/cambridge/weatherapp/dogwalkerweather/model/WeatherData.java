...
public class WeatherData {
    private String groundCondition; // Grass conditions
    ...
    public int getCurrentWindDirection() { return dailyForecast.get(0).getWindDirection(); }
    public double getCurrentWindGustSpeed() { return dailyForecast.get(0).getWindGustSpeed(); }
    public int getCurrentVisibility() { return dailyForecast.get(0).getVisibility(); }
    public double getCurrentRelativeHumidity() { return dailyForecast.get(0).getRelativeHumidity(); }
    public int getCurrentPressure() { return dailyForecast.get(0).getPressure(); }
    public int getCurrentUV() { return dailyForecast.get(0).getUV(); }
